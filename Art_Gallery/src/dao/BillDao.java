...
public class BillDao {
 ...
 public static void save(Bill  bill)   
 {
    ...
    public static ArrayList <Bill> getAllRecordByAsc(String date){
    ...
    public static ArrayList <Bill> getAllRecordByDesc(String date){
        ArrayList <Bill> arrayList = new ArrayList<>();
        try{
            ResultSet rs = DbOperations.getData("Select * from bill order by id desc where date like '%" + date + "%' order by id desc");
            Bill bill = new Bill();
            bill.setId(rs.getInt("id"));
            bill.setName(rs.getString("name"));
            bill.setMobileNumber(rs.getString("mobileNumber"));
